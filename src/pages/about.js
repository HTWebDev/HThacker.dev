    ...
    <Layout activePage="about">
      ...
      <div className="container">
        <article className="prose">
          <h2>About Me</h2>
          <p>
            I'm Hunter, I am Front-End web developer from Louisville Ky. I
            started learning how to code a little over a year ago in early 2020
            at the start of quarantine. I'm passionate about Art, Technology and
            Design.
            <br></br>
            ...
            carried this passion of the Internet of things into my teens and
            adult years.
          </p>
          <h2>My Interests</h2>
          <p>
            ...
            Ambient Electronica, Folk and indie to name a only a few. Cooking is
